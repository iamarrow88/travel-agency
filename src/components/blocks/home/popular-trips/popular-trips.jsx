...
function PopularTrips(props){
  ...
  return (
      <section className="most-popular pb-32">
        <div className="container relative">

          <SectionTitle title="Most popular trips" classNames="mb-20"/>

          <div className="buttons flex justify-end gap-2 absolute top-6 right-2">
          ...
          <div className="cards-wrapper grid grid-cols-2 gap-8 mb-16">
            {cards}
          </div>
